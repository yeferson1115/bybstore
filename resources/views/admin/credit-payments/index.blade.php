    ...
    <div class="card">
        <div class="card-body table-responsive">
            <table class="table table-striped">
                <thead><tr><th>ID</th><th>Crédito</th><th>Cédula</th><th>Referencia</th><th>Monto</th><th>Estado</th><th>Fecha</th></tr></thead>
                <tbody>
                    ...
                    @empty
                        <tr><td colspan="7" class="text-muted">No hay pagos registrados.</td></tr>
                    @endforelse
                </tbody>
            </table>
            {{ $payments->links() }}
